...
const I18n = (() => {
  ...
  const translations = {
    vi: {
      ...
      'play.voiceInput': 'Nhập bằng giọng nói',
      'play.voiceListening': 'Đang nghe... hãy nói đáp án',
      'play.voiceNotSupported': 'Trình duyệt không hỗ trợ nhận diện giọng nói (Web Speech API).',
      'play.voicePermissionDenied': 'Vui lòng cấp quyền truy cập micro cho trang web.',
      ...
      'results.chooseQuestionType': 'Chọn loại câu hỏi',
      'results.chooseQuestionTypeDesc': 'Chọn một loại câu hỏi để bắt đầu luyện tập:',
      ...
      'qtype.fill_word_ipa': 'Điền từ',
      'qtype.fill_word_ipa_desc': 'Từ → điền Phiên âm',
      'qtype.fill_meaning_ipa': 'Điền từ',
      'qtype.fill_meaning_ipa_desc': 'Nghĩa → điền Phiên âm',
    ...
    en: {
      ...
      'play.voiceInput': 'Voice input',
      'play.voiceListening': 'Listening... speak your answer',
      'play.voiceNotSupported': 'Speech recognition is not supported in this browser.',
      'play.voicePermissionDenied': 'Please allow microphone access for this website.',
      'common.undo': 'Undo',
      ...
      'results.chooseQuestionType': 'Select Question Type',
      'results.chooseQuestionTypeDesc': 'Select a question type to start practicing:',
      ...
      'qtype.fill_word_ipa': 'Fill',
      'qtype.fill_word_ipa_desc': 'Word → type Pinyin/IPA',
      'qtype.fill_meaning_ipa': 'Fill',
      'qtype.fill_meaning_ipa_desc': 'Meaning → type Pinyin/IPA',
